...
TRANSLATION.update({
    "glue.viewers.histogram.qt.data_viewer.HistogramViewer": "glue_jupyter.bqplot.histogram.BqplotHistogramView",  # remove?
    ...
    "glue.viewers.histogram.layer_artist.QThreadedHistogramLayerArtist": "glue_jupyter.bqplot.histogram.BqplotHistogramLayerArtist",  # remove?
    ...
    "glue_wwt.viewer.qt_data_viewer.WWTQtViewer": "glue_wwt.viewer.jupyter_viewer.WWTJupyterViewer",
})
