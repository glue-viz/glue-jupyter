...
def test_subset_select(app, datax, dataxyz, dataxz):
    ...
    assert subset_select.widget_menu_item_select_multiple_checkbox.checked == False
...
#     assert subset_select.widget_select.primary == subset_select.widget_menu_items_subsets[0].children[0].label
    assert subset_select.widget_select.value == 0
    assert subset_select.widget_menu_item_no_active.selected == False

    # assert len(subset_select.widgets.options) == len(app.data_collection.subset_groups)
    # assert len(subset_select.widgets.index) == 1

    app.session.edit_subset_mode.edit_subset = [app.data_collection.subset_groups[0]]
    assert subset_select.widget_select.value == 0
    assert subset_select.widget_menu_item_no_active.selected == False
    assert subset_select.widget_menu_items_subsets[0].selected == True


    # glue -> ui
    # we select no subsets, should go back to new subset
    app.session.edit_subset_mode.edit_subset = []
    assert subset_select.widget_menu_item_no_active.selected == True
    assert subset_select.widget_menu_items_subsets[0].selected == False
    assert subset_select.widget_select.value == 'new'
    ...
    assert subset_select.widget_menu_item_no_active.selected == False
    assert subset_select.widget_menu_items_subsets[0].selected == False
    assert subset_select.widget_menu_items_subsets[1].selected == True
    assert subset_select.widget_select.value == 1

    # we do not have multiple subsets enabled
    # subset_select.widget_menu_items_subsets[0].selected = True
    subset_select.widget_select.value = 0
    assert subset_select.widget_menu_items_subsets[0].selected == True
    assert subset_select.widget_menu_items_subsets[1].selected == False
    ...
    subset_select.widget_select.value = [0, 1]
    assert subset_select.widget_menu_items_subsets[0].selected == True
    assert subset_select.widget_menu_items_subsets[1].selected == True
    subset_select.widget_select.value = [0]
    assert subset_select.widget_menu_items_subsets[0].selected == True
    ...
    subset_select.widget_select.value = [1]
    subset_select.widget_menu_item_select_multiple_checkbox.checked = False
    assert subset_select.widget_select.value == 1
    assert subset_select.widget_menu_items_subsets[0].selected == False
    assert subset_select.widget_menu_items_subsets[1].selected == True
    ...
    subset_select.widget_select.value = []
    assert subset_select.widget_menu_items_subsets[0].selected == False
    assert subset_select.widget_menu_items_subsets[1].selected == False
    assert subset_select.widget_select.value == 'new'
